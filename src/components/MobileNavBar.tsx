  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 flex justify-center px-2 pb-4 sm:hidden">
      <div className="flex items-end gap-2">
        ...
        <Link
          href="/play"
          className={`-mt-14 flex flex-col items-center gap-0.5 rounded-full px-3 py-2.5 text-[10px] font-bold text-white shadow-md transition-transform duration-300 hover:scale-105 ${
